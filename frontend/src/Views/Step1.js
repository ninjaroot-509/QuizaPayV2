...
const Step1 = () => {
  ...
  <div className="content-grid">
    <div className="section-banner">
      <img className="section-banner-icon" src="https://quizapay.com/static/assets/img/banner/badges-icon.png" alt="badges-icon"/>
    ...
    <div className="grid grid-3-3-3-3 top-space centered">
      ...
      <div className="badge-item-stat"> 
        <img className="badge-item-stat-image" src="https://quizapay.com/static/assets/img/badge/bronze-b.png" alt="badge-bronze-b"/>
      ...
      <div className="badge-item-stat"> 
        <img className="badge-item-stat-image" src="https://quizapay.com/static/assets/img/badge/gold-b.png" alt="badge-gold-b"/>
        ...
        <p className="badge-item-stat-text">Cliquez ici, si vous voulez jouer avec un ami!</p>
          ...
          <div style={{paddingTop: 20}}>
            <Link to="challenge/etape-1" className="button secondary full">
              <svg className="button-icon icon-play" style={{margin: 5}}>
                <use xlinkHref="#svg-play"></use>
              </svg>
              Continuer
      ...
      <div className="badge-item-stat"> 
        <img className="badge-item-stat-image" src="https://quizapay.com/static/assets/img/badge/silver-b.png" alt="badge-silver-b"/>

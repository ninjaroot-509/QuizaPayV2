  ...
  <div className="content-grid">
    ...
    <div className="grid grid-3-3-3-3 top-space centered">
      ...
      <div className="badge-item-stat"> 
        ...
        <p className="badge-item-stat-text">Cliquez ici, si vous voulez jouer seule</p>
      ...
      <div className="badge-item-stat"> 
        ...
        <p className="badge-item-stat-text">Cliquez ici, si vous voulez jouer avec un amis</p>
      ...
      <div className="badge-item-stat"> 
        ...
        <p className="badge-item-stat-title">QuizaPay plusieur</p>
    
        <p className="badge-item-stat-text">Cliquez ici, si vous voulez y jouer avec plusieur personnes</p>

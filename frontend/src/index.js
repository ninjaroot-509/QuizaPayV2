...
import { INITIAL_STATE as PRINCING_INITIAL_STATE } from './state/princing/reducers';
import { INITIAL_STATE as PRODUIT_INITIAL_STATE } from './state/produit/reducers';
...
const initialState = {
  ...
  princing: PRINCING_INITIAL_STATE,
  produit: PRODUIT_INITIAL_STATE
};

...
const StepC1 = ({handleCreateLa, joinGame, conthandle}) => {
    ...
    <div className="content-grid">
      <div className="max-w-sm mx-4 p-6 shadow-lg rounded-md">
        ...
        <form className="w-full mb-4">
          ...
          <input
            className={"p-2 shadow w-full text-sm " + (gameIDError.error ? " border-2 border-red-800" : "")}
            id="gameID"
            name="gameID"
          ...
          <button
            ...
            type="submit"
            className="w-full bg-purple-800 hover:bg-purple-700 text-white uppercase shadow py-2 px-4 tracking-wide rounded text-sm"
